...
impl<SPI, BUSY, DC, RST, DELAY> ErrorType<SPI, BUSY, DC, RST> for Epd4in2<SPI, BUSY, DC, RST, DELAY>
where
    SPI: SpiDevice,
    ...
    DELAY: DelayNs,
{
    ...
    /// `QuickRefresh` device.
    fn display_new_frame(&mut self, spi: &mut SPI, delay: &mut DELAY) -> Result<(), Self::Error> {
