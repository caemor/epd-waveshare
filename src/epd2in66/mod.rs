//! A simple Driver for the Waveshare 2.66" E-Ink Display via SPI
//!
//! # References
//!
...
impl<SPI, CS, BUSY, DC, RST, DELAY> InternalWiAdditions<SPI, CS, BUSY, DC, RST, DELAY>
    for Epd2in66<SPI, CS, BUSY, DC, RST, DELAY>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
    ...
    DELAY: DelayMs<u8>,
{
    fn init(&mut self, spi: &mut SPI, delay: &mut DELAY) -> Result<(), SPI::Error> {
        ...
        // This is in all the Waveshare controllers for Epd2in66
    ...
    DELAY: DelayMs<u8>,
{
    ...
    fn new(
        ...
        let mut epd = Epd2in66 { interface, color };
...
impl<SPI, CS, BUSY, DC, RST, DELAY> Epd2in66<SPI, CS, BUSY, DC, RST, DELAY>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
